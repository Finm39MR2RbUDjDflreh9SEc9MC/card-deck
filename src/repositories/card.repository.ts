...
> {
  ...
  public readonly decks: HasManyThroughRepositoryFactory<Deck, typeof Deck.prototype.id,
          Deckcard,
          typeof Card.prototype.id
        >;

  public readonly deckcards: HasManyRepositoryFactory<Deckcard, typeof Card.prototype.id>;

  constructor(
    @inject('datasources.appdatasource') dataSource: AppdatasourceDataSource, @repository.getter('DeckcardRepository') protected deckcardRepositoryGetter: Getter<DeckcardRepository>, @repository.getter('DeckRepository') protected deckRepositoryGetter: Getter<DeckRepository>,
  ) {
